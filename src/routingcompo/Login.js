            ...
            <div className='mx-auto px-2 col-md-6'>
                <div className='border p-3'>
                    ...
                    <div className='mb-2 mt-2'>
                        ...
                        <input type='text' className='w form-control' name='email'></input>
                    ...
                    <div>
                        <button type='button' className='btn bg-black text-white me-1 form-btn'></button>
                        <a className='text-blue' href='/'>Forgotten Password</a>
                    </div>
                </div>
            </div>
        </div>
